...
.com{
	width:20px;
        ...
        <div class="blog-1">        
                ...
                <?php echo '<h1 style="margin-top:10px;">'.$row['Title'].'</h1>';
                      ...
                      <form method="post" action="" enctype="multipart/form-data" class="clearfix">
						<input style="margin-bottom:10px;" type="text" name="comment" placeholder="Comments"/>
                        <input style="width:70px;" type="submit" value="POST" class="com" name="commen"/>
                      </form>
                      <?php
	...
	else
	{
		echo "<script>alert('ERROR')</script>";
					  ...
					  ?>
                      <?php
			$query = mysqli_query($con, "select * from comments where BlogID = '".$row['ID']."'");
			while($row = mysqli_fetch_array($query)){
...
<footer id="footer" class="clearfix">
	<div class="container clearfix wow wow fadeInUp">
    	...
    	<div class="one-third">
            ...
            <a href="#">DEVELOPMENT</a>
           	...
           	<h1 class="foot-bold">TWITTER WIDGET</h1>
            <p class="foot-tweet"><span>WebLionMedia</span> font based on the style of lettering seen on cassandre posters designed by atipo, download it fo free: <span>cassannet.net</span></p>
            <p class="about">about 230 days ago</p>
        </div>
    ...
    <div class="company">
    	<p>© Copyright 2013 by WebLionMedia. All Rights Reserved.</p>
    </div>
</footer>
